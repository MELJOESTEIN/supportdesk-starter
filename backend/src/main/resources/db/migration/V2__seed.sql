...
INSERT INTO ticket (reference, sujet, description, categorie, statut, priorite,
    ...
    ('TCK-4821', 'Facture de mars non telechargeable', 'Depuis ce matin le bouton de telechargement de la facture de mars ne repond plus. Les factures d''avril et mai se telechargent normalement. J''ai essaye sur Chrome et Firefox, meme resultat.', 'FACTURATION', 'OUVERT', 'NORMALE',
     ...
     'alice', '2026-08-24T10:40:00+00:00', '2026-08-24T08:40:00+00:00');
...
INSERT INTO commentaire (ticket_id, auteur_username, auteur_type, contenu, visibilite, cree_le)
    SELECT id, 'carol', 'AGENT', 'Documents anterieurs a la migration du 12 mars : le lien signe pointe vers l''ancien bucket. Ticket infra INF-217 ouvert. Ne pas mentionner la migration au client, la communication officielle part vendredi.', 'INTERNE', '2026-08-24T08:40:00+00:00' FROM ticket WHERE reference = 'TCK-4821';
INSERT INTO commentaire (ticket_id, auteur_username, auteur_type, contenu, visibilite, cree_le)
    SELECT id, 'bob', 'AGENT', 'Bonjour, merci pour ces precisions. Je reproduis le probleme sur la facture de mars uniquement. Je la regenere et vous reviens aujourd''hui.', 'PUBLIC', '2026-08-24T08:40:00+00:00' FROM ticket WHERE reference = 'TCK-4821';
INSERT INTO commentaire (ticket_id, auteur_username, auteur_type, contenu, visibilite, cree_le)
...
INSERT INTO evenement_ticket (ticket_id, type, auteur_username, detail, cree_le)
    SELECT id, 'NOTE_INTERNE', 'carol', 'note interne ajoutee', '2026-08-24T08:40:00+00:00' FROM ticket WHERE reference = 'TCK-4821';
INSERT INTO evenement_ticket (ticket_id, type, auteur_username, detail, cree_le)
